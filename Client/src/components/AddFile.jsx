            ...
            <div className="w-full overflow-y-auto flex flex-col justify-start items-center h-auto max-h-[40rem] bg-white rounded-md ">
                <div className='flex flex-col justify-center items-center w-[70%] h-[10rem]'>
                    ...
                    <div className='flex justify-center items-center gap-6'>
                        <span onClick={()=> setToggle(true)} className='bg-tblue px-10 py-3 text-lg cursor-pointer rounded-md text-[#fff]'>Document</span>
                        <span className='bg-[#EFF0F5]  px-16 cursor-pointer py-3 text-lg rounded-md text-[#000]'>Link</span>
                    </div>
                </div>
