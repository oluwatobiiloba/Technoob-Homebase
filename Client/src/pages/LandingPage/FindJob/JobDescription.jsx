...
function JobDescription() {
  return (
    <div className="sm:mt-20 sm:px-20 mt-10 px-10">
      <div className="flex justify-between mb-8 shadow-md py-3">
        <h1 className="sm:text-3xl text-xl text-[#27AE60]">Job Description</h1>
        <svg
          width="32"
          height="33"
          viewBox="0 0 32 33"
        ...
        >
          <path
            d="M16.0009 14.6153L22.6005 8.01562L24.4861 9.90124L17.8865 16.5009L24.4861 23.1005L22.6005 24.9861L16.0009 18.3865L9.40124 24.9861L7.51562 23.1005L14.1153 16.5009L7.51562 9.90124L9.40124 8.01562L16.0009 14.6153Z"
            fill="black"
          />
        </svg>
      </div>
      ...
      <div className="flex flex-col py-3 px-10 border border-[#BDBDBD] rounded-md mb-10 max-w-fit" >
        ...
        <div className="flex gap-5">
          <h2 className="text-xs  text-green-500 bg-green-100 flex justify-center items-center p-2 sm:py-2 sm:px-4 rounded-md sm:text-sm font-normal">
            Full-Time
          </h2>
      ...
      <div className=" mb-5 flex">
        <button className="w-[40%] sm:w-[201px] h-[54px] text-base font-[400] bg-[#5E7CE8] rounded-md text-[#F2F2F2] py-4 px-3.5 mr-6">
          Apply
        </button>

        <button className="w-[40%] sm:w-[201px] h-[54px] text-base font-[400] bg-[#EFF0F5] rounded-md text-[#111111] py-4 px-3.5">
          Back
        </button>
      </div>
