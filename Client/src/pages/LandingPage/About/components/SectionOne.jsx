...
const SectionOne = () => {
  return (
    <section className='nun flex xl:flex-row flex-col-reverse flex-1 md:px-20 md:py-20 space-x-1 justify-center px-5 xl:text-left text-center'>
        <div className=' md:mt-10 lg:w-[50%]'>
            ...
            <p className=' md:text-xl text-sm text-tblackk'>Our culture is built around our love of technology. We are a group <br /> of passionate tech enthusiasts who are committed to sharing our knowledge <br /> and expertise with ourselves and the general public. <br /><br /> We value accuracy, integrity, and passion, and we believe that these values are reflected in the content that we produce.</p>
