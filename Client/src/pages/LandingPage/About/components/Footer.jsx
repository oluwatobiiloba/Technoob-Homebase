...
const Footer = () => {
  ...
  return (
    <footer className=' flex-col px-5 text-center bg-twhitee py-10'>
        ...
        <form>
            <input type="email" value={email} onChange={handleChange} placeholder='Enter your email address' className=' rounded m-1 ring-1 border w-full px-10 py-4 placeholder:italic' />
