...
const SectionTwo = () => {
  return (
    <section className='nun xl:flex xl:flex-1 md:px-20 md:py-20 space-x-1 justify-center px-5 xl:text-left text-center'>
        ...
        <div className="xl:text-left text-center lg:w-[50%] lg:px-10 py-10 lg:mt-[-80px] ">
            <h1 className='font-bold lg:text-6xl text-[38px] py-5 lg:h-[24px] lg:my-20 md:my-4'><span className=' text-tgreen'>Our</span><span className=' text-tblue'> Commitment</span> </h1>
            <p className='text-sm md:text-xl md:pt-[30px] text-tblackk'>
